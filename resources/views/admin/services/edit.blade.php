@extends('layouts.vertical', ['title' => 'Edit Service Type'])
@section('content')
<!-- Start Content-->
<div class="container-fluid">
         ...
         <div class="page-title-box">
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Service Type</a></li>
               </ol>
            </div>
   ...
   <div class="row">
      <div class="col-lg-12 card">
         ...
         @endif
         <form method="Post" action="{{ route('services.update',[$edit->id]) }}" enctype="multipart/form-data" name="gift_store">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Service Name <code>*</code></label>
                         <input type="text" name="name" class="form-control" value="{{$edit->name}}"   required="" placeholder="Service Name">
                     </div>
                     ...
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Need Availability <code>*</code></label>
                         <select class="form-control gift" name="need_availability" required="">
                             ...
                             <option value="1" <?php if($edit->need_availability==1){ echo 'selected'; } ?>>Yes</option>
                             <option value="0" <?php if($edit->need_availability==0){ echo 'selected'; } ?>>No</option>
                         </select>
                     </div>
                     ...
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Service Type  <code>*</code></label>
                         <select class="form-control gift" name="type_id" required="">
                             ...
                             <option value="{{$service->id}}" <?php if($edit->type_id==$service->id){ echo 'selected'; } ?>>{{$service->servive_name}}</option>
                              @endforeach
                         </select>
                     </div> 
                     ...
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Color picker</label>
                         <input type="color" name="color_code" class="form-control" value="{{$edit->color_code}}"  required="" placeholder="Title">
                     </div>
